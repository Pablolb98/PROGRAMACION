...
public class VentanaFabricante {
	...
	private void cargarActualEnPantalla() {
		if (this.actual != null) {
			...
			this.jtfNombre.setText(this.actual.getName());
	...
	private void cargarActualDesdePantalla() {
		...
		this.actual.setName(jtfNombre.getText());
	...
	private void initialize() {
		...
		gbc_jtfCif.gridx = 1;
		gbc_jtfCif.gridy = 1;
		frame.getContentPane().add(jtfCountryCode, gbc_jtfCif);
	...
	private void borrar() {
	    ...
	    if(opcionElegida == 0) {
	    	int regsAfectados = ControladorFabricante.getInstance().borrar(this.actual.getCountryCode());
	    	if (regsAfectados > 0) {
	    		vaciarCampos();
